    ...
    <header class="header">
        <div class="container header-inner">
            ...
            <div class="header-ctas">
                <a href="/index.html#contact" class="header-cta">AI活用案を無料で聞く<span class="arrow">→</span></a>
            </div>
        </div>
    </header>
...
${bodyHtml}
    ...
    <script src="/script.js"></script><script src="/blog/posts.js"></script><script src="/blog/blog.js?v=real-views-hide-zero-20260717-v2"></script><script src="/analytics.js?v=ga4-funnel-20260717-v1"></script>
</body>
</html>`;
